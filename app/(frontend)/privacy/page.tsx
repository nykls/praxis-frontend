      ...
      <div className="flex-col space-y-3 pt-25">
        ...
        <div className="md:px-20 lg:px-36">
          ...
          <Typography variant="p">
            ...
            Website Cloudflare CDN. Cloudflare CDN ist ein Dienst der
            Cloudflare, Inc., welcher auf unserer Website als Content Delivery
            Network (CDN) fungiert.
          </Typography>
          <Typography variant="p">
            Ein CDN trägt dazu bei, Inhalte unseres Onlineangebotes,
            insbesondere Dateien wie Grafiken oder Skripte, mit Hilfe regional
            oder international verteilter Server schneller bereitzustellen. Wenn
            Sie auf diese Inhalte zugreifen, stellen Sie eine Verbindung zu
            Servern der Cloudflare, Inc., her, wobei Ihre IP-Adresse und ggf.
            Browserdaten wie Ihr User-Agent übermittelt werden. Diese Daten
            werden ausschließlich zu den oben genannten Zwecken und zur
            Aufrechterhaltung der Sicherheit und Funktionalität von Cloudflare
            CDN verarbeitet.
          </Typography>
          ...
          <Typography variant="p">
            ...
            unserer berechtigten Interessen, d.h. Interesse an einer sicheren
            und effizienten Bereitstellung sowie der Optimierung unseres
            Onlineangebotes gemäß Art. 6 Abs. 1 lit. f. DSGVO.
          </Typography>
          <Typography variant="p">
            Wir beabsichtigen personenbezogenen Daten an Drittländer außerhalb
            des Europäischen Wirtschaftsraums, insbesondere die USA, zu
            übermitteln. In Fällen, in denen kein Angemessenheitsbeschluss der
            Europäischen Kommission existiert (z.B. in den USA) haben wir mit
            den Empfängern der Daten anderweitige geeignete Garantien im Sinne
            der Art. 44 ff. DSGVO vereinbart. Dies sind – sofern nicht anders
            angegeben – Standardvertragsklauseln der EU-Kommission gemäß
            Durchführungsbeschluss (EU) 2021/914 vom 4. Juni 2021. Eine Kopie
            dieser Standardvertragsklauseln können Sie{' '}
            <Link
              className="text-primary underline"
          ...
          <Typography variant="p">
            Die konkrete Speicherdauer der verarbeiteten Daten ist nicht durch
            uns beeinflussbar, sondern wird von Cloudflare, Inc. bestimmt.
          ...
          <Typography variant="p">
            ...
            oder international verteilter Server schneller bereitzustellen. Wenn
            Sie auf diese Inhalte zugreifen, stellen Sie eine Verbindung zu
            Servern der Google Ireland Limited, Gordon House, Barrow Street,
            Dublin 4, Irland her, wobei Ihre IP-Adresse und ggf. Browserdaten
            wie Ihr User-Agent übermittelt werden. Diese Daten werden
          ...
          <Typography variant="p">
            Die konkrete Speicherdauer der verarbeiteten Daten ist nicht durch
            uns beeinflussbar, sondern wird von Google Ireland Limited bestimmt.
            Weitere Hinweise finden Sie in der{' '}
            <Link
              className="text-primary underline"
          ...
          <Typography variant="p">
            ...
            welcher auf unserer Website als Content Delivery Network (CDN)
            fungiert.
          </Typography>
          <Typography variant="p">
            Ein CDN trägt dazu bei, Inhalte unseres Onlineangebotes,
            ...
            oder international verteilter Server schneller bereitzustellen. Wenn
            Sie auf diese Inhalte zugreifen, stellen Sie eine Verbindung zu
            Servern der Prospect One, Krolewska 65a, Krakow, Malopolskie 30-081,
            Poland her, wobei Ihre IP-Adresse und ggf. Browserdaten wie Ihr
            ...
            und Funktionalität von JSDelivr CDN verarbeitet.
          </Typography>
          <Typography variant="h3">Zweck und Rechtsgrundlage</Typography>
          <Typography variant="p">
            Die Nutzung des Content Delivery Networks erfolgt auf Grundlage
          ...
          <Typography variant="p">
            Die konkrete Speicherdauer der verarbeiteten Daten ist nicht durch
            uns beeinflussbar, sondern wird von Prospect One bestimmt. Weitere
          ...
          <Typography variant="p">
            ...
            Wenn Sie auf diese Inhalte unserer Website zugreifen, stellen Sie
            eine Verbindung zu Servern der Google Ireland Limited, Gordon House,
            Barrow Street, Dublin 4, Irland her, wobei Ihre IP-Adresse und ggf.
            Browserdaten wie Ihr User-Agent übermittelt werden. Diese Daten
            werden ausschließlich zu den oben genannten Zwecken und zur
            Aufrechterhaltung der Sicherheit und Funktionalität von Google Maps
            verarbeitet.
          </Typography>
          <Typography variant="h3">Zweck und Rechtsgrundlage</Typography>
          <Typography variant="p">
          ...
          <Typography variant="p">
            ...
            Einwilligung nach Art. 49 Abs. 1 Satz 1 lit. a. DSGVO ein, die Sie
            über die Einwilligung im Consent Manager (oder sonstigen Formularen,
            ...
            genauer Umfang und deren Folgen für Sie wir nicht kennen, auf die
            wir keinen Einfluss haben und von denen Sie unter Umständen keine
            Kenntnis erlangen) bestehen können.
          </Typography>
          <Typography variant="h3">Speicherdauer</Typography>
          <Typography variant="p">
            Die konkrete Speicherdauer der verarbeiteten Daten ist nicht durch
          ...
          <Typography variant="h3">Zweck und Rechtsgrundlage</Typography>
          <Typography variant="p">
            Der Einsatz von Google Fonts erfolgt auf Grundlage Ihrer
