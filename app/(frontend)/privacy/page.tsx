    ...
    <FullWidthWrapper>
      <div className="space-y-3 flex-col">
        ...
        <Typography variant="p">
          ...
          Sitz unseres Unternehmens befindet. Der{" "}
          <Link
        ...
        <Typography variant="p">
          ...
          der Cloudflare, Inc., her, wobei Ihre IP-Adresse und ggf. Browserdaten
          ...
          der Sicherheit und Funktionalität von Cloudflare CDN verarbeitet.
        </Typography>
        ...
        <Typography variant="p">
          ...
          Europäischen Wirtschaftsraums, insbesondere die USA, zu übermitteln.
          In Fällen, in denen kein Angemessenheitsbeschluss der Europäischen
          Kommission existiert (z.B. in den USA) haben wir mit den Empfängern
          der Daten anderweitige geeignete Garantien im Sinne der Art. 44 ff.
          DSGVO vereinbart. Dies sind – sofern nicht anders angegeben –
        ...
        <Typography variant="p">
          ...
          international verteilter Server schneller bereitzustellen. Wenn Sie
          auf diese Inhalte zugreifen, stellen Sie eine Verbindung zu Servern
          der Prospect One, Krolewska 65a, Krakow, Malopolskie 30-081, Poland
          ...
          Funktionalität von JSDelivr CDN verarbeitet.
        </Typography>
        <Typography variant="h3">Zweck und Rechtsgrundlage</Typography>
        <Typography variant="p">
          Die Nutzung des Content Delivery Networks erfolgt auf Grundlage
        ...
        <Typography variant="p">
          Die konkrete Speicherdauer der verarbeiteten Daten ist nicht durch uns
          beeinflussbar, sondern wird von Prospect One bestimmt. Weitere
          Hinweise finden Sie in der{" "}
          <Link
